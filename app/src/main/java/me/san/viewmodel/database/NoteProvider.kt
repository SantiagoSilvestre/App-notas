package me.san.viewmodel.database
...
import me.san.viewmodel.database.NotesDatabaseHelper.Companion.TABLE_NOTES
...
class NoteProvider : ContentProvider() {
    ...
    override fun delete(uri: Uri, selection: String?, selectionArgs: Array<String>?): Int {
        if (mUriMatcher.match(uri) == NOTES_BY_ID) {
            ...
            val linesAffec = db.delete(TABLE_NOTES, "$_ID = ?", arrayOf(uri.lastPathSegment))
            db.close()
    ...
    override fun getType(uri: Uri): String? = throw UnsupportedSchemeException("URI não implementável")
    ...
    companion object {
        const val AUTHORITY = "me.san.viewmodel.provider"
